...
public class PreferenceManagerClass {
    ...
    private static final String MESSAGE_HASH = "messsage_hash";
    ...
    public static void setMessageHash(Context context, String hash) {
        SharedPreferences.Editor editor = getSharedPreferences(context).edit();
        editor.putString(MESSAGE_HASH, hash);
        editor.apply();
    }

    public static String getMessageHash(Context context) {
        return getSharedPreferences(context).getString(MESSAGE_HASH, "");
    }
